...
if __name__=='__main__':
	...
	parser.add_argument('--download_db', help='optional,strategy for downloading the database: manual or automatic,automatic download by default for the first time.\n')
	...
	if args.download_db:
		download_db = rgs.download_db
	else:
		download_db = 'automatic'

	if download_db == 'automatic':
		flag = 0
